...
M.groups = {
  ...
  "Comment",                              { bg = colors.NONE, fg = colors.nickel }, -- Any comment
  "Constant",                             { bg = colors.NONE, fg = colors.white_chocolate }, -- (*) Any constant
  "String",                               { bg = colors.NONE, fg = colors.light_slate }, --   A string constant: "this is a string"
  "Character",                            { bg = colors.NONE, fg = colors.white_chocolate }, --   A character constant: 'c', '\n'
  ...
  "Identifier",                           { bg = colors.NONE, fg = colors.white_chocolate, sp = "none" }, -- (*) Any variable name
  "Function",                             { bg = colors.NONE, fg = colors.gentle_blue }, --   Function name (also: methods for classes)
  "Statement",                            { bg = colors.NONE, fg = colors.white_chocolate }, -- (*) Any statement
  "Conditional",                          { bg = colors.NONE, fg = colors.pastel_gray }, --   if, then, else, endif, switch, etc.
  "Repeat",                               { bg = colors.NONE, fg = colors.weldon }, --   for, do, while, etc.
  "Label",                                { bg = colors.NONE, fg = colors.weldon }, --   case, default, etc.
  "Operator",                             { bg = colors.NONE, fg = colors.lavender, sp = "none" }, --   "sizeof", "+", "*", etc.
  ...
  "Include",                              { bg = colors.NONE, fg = colors.gentle_blue }, --   Preprocessor #include
  ...
  "PreCondit",                            { bg = colors.NONE, fg = colors.weldon }, --   Preprocessor #if, #else, #endif, etc.
  "Type",                                 { bg = colors.NONE, fg = colors.weldon, sp = "none" }, -- (*) int, long, char, etc.
  "StorageClass",                         { bg = colors.NONE, fg = colors.weldon }, --   static, register, volatile, etc.
  "Structure",                            { bg = colors.NONE, fg = colors.pastel_gray }, --   struct, union, enum, etc.
  "Typedef",                              { bg = colors.NONE, fg = colors.weldon }, --   A typedef
